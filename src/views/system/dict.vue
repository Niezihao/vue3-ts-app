<template>
  ...
  <div class="content-container">
    ...
    <dataTable
      ...
      row-key="id"
      :tree-props="{ children: 'dict_items' }"
      border
      default-expand-all
    >
      <!-- 标题插槽 -->
    ...
    >
      <L-form
        v-model:formData="state.ItemFormData"
      ...
      >
        <template #action="{ form, model }">
          <div slot="footer" class="dialog-footer">
            <el-button type="primary" @click="submitItemForm(form)"
              >确 定</el-button
            >
...
const tableState = reactive({
  ...
  searchConfig: [{ type: "input", prop: "dict_name", label: "字典名称" }],
  searchReset: {
    dict_name: undefined,
  },
  searchBtnConfig: {
...
const state = reactive({
  ...
  formOptions: [
    ...
    },
    {
      ...
      placeholder: "请输入字典描述",
      prop: "description",
      rules: [{ required: true, message: "字典描述不能为空", trigger: "blur" }],
    },
    {
      type: "radio-group",
      value: "1",
  ...
  itemFormOptions: [
    ...
    },
    {
      ...
      placeholder: "请输入字典项值",
      prop: "item_text",
      rules: [{ required: true, message: "字典项值不能为空", trigger: "blur" }],
    },
    {
      type: "input",
      value: 0,
      label: "字典项键",
      prop: "item_value",
      rules: [{ required: true, message: "字典项键不能为空", trigger: "blur" }],
    },
    {
      type: "input",
      value: "",
