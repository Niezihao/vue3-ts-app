    ...
    >
      ...
      >
        ...
        <el-form-item label="菜单类型" prop="type">
          ...
          >
            <el-radio v-for="item in dict.authType" :label="item.value">{{
              item.label
            }}</el-radio>
          </el-radio-group>
        </el-form-item>
        ...
        >
          <el-input
            ...
            style="width: 95%"
          >
            <template v-if="formData.parent_id != 0" #prepend
              >src/views/</template
            >
        ...
        <el-form-item label="状态" v-if="formData.type !== 'B'">
          <el-radio-group v-model="formData.hidden">
            <el-radio v-for="item in dict.hidden" :label="item.value">{{
              item.label
            }}</el-radio>
          </el-radio-group>
        </el-form-item>
...
const tableState = reactive({
  ...
  searchConfig: [{ type: "input", prop: "title", label: "菜单标题" }],
  searchReset: {
    title: undefined,
  },
  searchBtnConfig: {
...
const { dialog, formData, menuOptions, rules, iconSelectVisible, cacheData } =
  toRefs(state);
