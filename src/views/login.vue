    ...
    <div class="logindata">
        ...
        >
          ...
          <el-form-item prop="checkCode">
            <el-input
              ...
              clearable
            ></el-input>
            <div class="login-code" @click="getCode" v-html="verifyImg"></div>
          </el-form-item>
          <el-form-item prop="remember">
            <el-checkbox v-model="form.remember" class="check-box"
              >记住密码</el-checkbox
            >
          </el-form-item>
        </el-form>
      ...
      <div class="butt">
        <el-button
          :loading="loading"
          type="primary"
          @click.stop.prevent="submitForm(ruleFormRef)"
          >登录</el-button
        >
...
function getCookie() {
  ...
  form.password = password === undefined ? form.password : decrypt(password) as string;
